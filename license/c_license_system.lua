...
local Johnson = createPed(13,  1111.3486328125, -775.755859375, 976.25158691406)
setPedRotation(Johnson, 99)
setElementDimension(Johnson, 17)
setElementInterior(Johnson, 5)
setElementData( Johnson, "talk", 1, false )
setElementData( Johnson, "name", "Gamze Avcı", false )

local dominick = createPed(187,  1108.544921875, -767.5986328125, 976.25158691406)
setPedRotation(dominick, 186)
setElementDimension(dominick, 17)
